    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="password" placeholder="Passwort" class="form-control" ng-model="vm.user.oldpassword"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="password" placeholder="Neues Passwort" class="form-control" ng-model="vm.user.password"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="password" placeholder="Neues Passwort wiederholen" class="form-control" ng-model="vm.user.repassword"/>
                    </div>
                </div>
              ...
              <div class="col-md-4">
                ...
                <div class="image-container" ng-show="vm.user.image">
                    <div class="img-btn-container">
                        ...
                        <button class="btn btn-dlt-img" ng-click="vm.deleteImage(vm.user.id)">Löschen</button>
                    </div>
                </div>
